	...
	<div class="header-container">
		<div class="header-template header-v3 <?php echo esc_attr(implode(' ', $extra_class)); ?>">
			...
			<div class="header-middle header-sticky">
				<div class="logo-wrapper logo-ipad"><?php echo upstore_theme_logo(); ?></div>
				<div class="container">
					<div class="logo-wrapper visible-phone"><?php echo upstore_theme_logo(); ?></div>
					<div class="menu-wrapper hidden-phone">							
						<div class="ts-menu">
							<?php 
								if ( has_nav_menu( 'primary' ) ) {
									wp_nav_menu( array( 'container' => 'nav', 'container_class' => 'main-menu pc-menu ts-mega-menu-wrapper','theme_location' => 'primary','walker' => new Upstore_Walker_Nav_Menu() ) );
								}
								else{
